...
import CustomerReviewPage from "/pages/CustomerReviewPage.js";
...
const routes = [
  ...
  {
    path: "/admin/services/create_services",
    component: AdminCreateServicesPage,
  },
  {
    path: "/admin/services/update/:id",
    component: AdminCreateServicesPage,
    props: (route) => ({ editing: true, id: route.params.id }),
  },
