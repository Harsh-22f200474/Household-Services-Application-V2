export default {
  template: `
      ...
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="card shadow-sm">
            <div class="card-body">
              <h3 class="card-title mb-4">Admin Search</h3>
      ...
      <!-- Search Results -->
      <div class="row mt-5" v-if="hasResults">
        <div class="col-12">
          <!-- Services Results -->
          <div v-if="services.length" class="card mb-4 shadow-sm">
            <div class="card-body">
          ...
          <div v-if="professionals.length" class="card mb-4 shadow-sm">
            <div class="card-body">
              <h4 class="card-title mb-3">Professionals</h4>
              <div class="table-responsive">
                <table class="table table-striped">
                  <thead>
                    <tr>
          ...
          <div v-if="serviceRequests.length && !customers.length" class="card mb-4 shadow-sm">
            <div class="card-body">
          ...
          <!-- Customer Results -->
          <div v-if="customers.length" class="card mb-4 shadow-sm">
            <div class="card-body">
              <h4 class="card-title mb-3">Customer Service History</h4>
              <div class="table-responsive">
                <table class="table table-striped">
                  <thead>
                    <tr>
